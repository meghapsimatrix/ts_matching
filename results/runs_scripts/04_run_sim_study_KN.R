...
# use your zip code!
set.seed(20001) # change this seed value!
...
save(params, results, session_info, run_date, file = "results/results/simulation_results_kn_200a.Rdata")
...
# make sure this is different for each person! :D 
# use your zip code!
set.seed(95404) # change this seed value!
...
# upload results to sharepoint and let megha know
# megha to upload on github
save(params, results, session_info, run_date, file = "results/results/simulation_results_kn_200b.Rdata")