...
setwd("C:/Users/mlachowicz/American Institutes for Research in the Behavioral Sciences/TFA AC Evaluation - !Methods Paper/simulation/code")

#-----------------------------------------------------------
# Source the functions
#-----------------------------------------------------------

source("ts_matching-main 10/01_dgm/01_dgm_function.R")
source("ts_matching-main 10/02_estimation_methods/02_estimation_functions.R")
source("ts_matching-main 10/03_performance_criteria/03_calc_performance.R")
...
# use your zip code!
set.seed(21211) # change this seed value!
...
save(params, results, session_info, run_date, file = "test/simulation_results_mjl1.Rdata")
