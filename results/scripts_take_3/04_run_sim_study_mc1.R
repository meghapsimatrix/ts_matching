...
source("ts_matching_Take3/01_dgm/01_dgm_function.R")
source("ts_matching_Take3/02_estimation_methods/02_estimation_functions.R") 
source("ts_matching_Take3/03_performance_criteria/03_calc_performance.R")
...
params <-
  ...
  mutate(
    iterations = 200, # change this to how many ever iterations - RUN 400 AT ONCE OR 200 TWICE
...
save(params, results, session_info, run_date, file = "runs_Take3/simulation_results_mc1.Rdata")
