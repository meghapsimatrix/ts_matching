...
# use your zip code!
set.seed(12666) # change this seed value!
...
params <-
  ...
  mutate(
    iterations = 300, # change this to how many ever iterations - RUN 400 AT ONCE OR 200 TWICE
...
save(params, results, session_info, run_date, file = "runs_Take4/simulation_results_mc3.Rdata")
