...
source("ts_matching_Take4/01_dgm/01_dgm_function.R")
source("ts_matching_Take4/02_estimation_methods/02_estimation_functions.R") 
source("ts_matching_Take4/03_performance_criteria/03_calc_performance.R")
    ...
    rerun(iterations, {
     ...
     cluster_level_dat <- 
        ...
        summarize(school_id = mean(school_id),
                  ...
                  V_q5 = as.factor(as.character(mean(as.numeric(V_q5)))),
...
# use your zip code!
set.seed(94541) # change this seed value!
...
params <-
  ...
  mutate(
    iterations = 20, # change this to how many ever iterations - RUN 400 AT ONCE OR 200 TWICE
...
save(params, results, session_info, run_date, file = "runs_Take4/simulation_results_mctest.Rdata")
